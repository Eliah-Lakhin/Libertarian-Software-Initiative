...
ценности. Поэтому предоставляя свою работу другим лицам, Автор рассматривает
данное действие как форму бессрочной и бесплатной аренды без права изменять
содержание работы. Так же Автор оставляет за собой право отзыва лицензий,
в качестве крайней дополнительной меры, гарантирующей его права, как
...
### Секция 2. Условия и Положения.
  ...
  - 2.4. Если _Лицензиат_ является физическим лицом, действует в отношении
    ...
    _Лицензиату_ "Лицензию для физических лиц"(Секция 5).
  ...
  - 2.8. Любая из предоставляемых по условиям настоящего
    _Лицензионного Соглашения_ лицензия является **не эксклюзивной**, то есть
...
_Авторское Произведение_:
  ...
  - 3.1.2. Право создания и распространение _Скомпилированной Работы_,
    при условии, что _Лицензиат_ прилагает _Уведомление об Авторском Праве_ к
    распространяемым _Скомпилированным Работам_, актуальное на момент создания
    _Скомпилированной Работы_, и при условии, что _Скомпилированная Работа_ не
    будут распространяться с коммерческой целью.
...
_Авторское Произведение_:
  ...
  - 4.1.2 Право создания и распространение _Скомпилированной Работы_,
    ...
    коммерческой целью), но, насколько это позволяет закон, не налагающих на
    _Автора_ иной ответственности в отношении третьих лиц, и до момента отзыва
    лицензии согласно правилам, установленным _Лицензионным Соглашением_.

  - 4.1.3. Право _Использования по Назначению_, при условии, что, насколько это
    позволяет закон, созданные _Лицензиатом_ продукты и произведения в
    результате _Использования по Назначению_ не налагают на _Автора_ иной
    ответственности в отношении третьих лиц.
  ...
  - 4.1.4. Право создания _Комплементарной Работы_.
