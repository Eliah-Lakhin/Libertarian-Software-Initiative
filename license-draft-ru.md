...
**Ключевыми особенностями данной Лицензии** является следующее:

  1. Данная Лицензия спроектирована для индивидуальных независимых авторов,
     работающих над собственными проектома самостоятельно, без участия иных
     ...
     Конкретные примеры вариантов использования, приводятся в разделе
     "Применение". **Для лучшего понимания экономической и юридической сути
     функционирования Libertarian Software** мы рекомендуем предварительно
     ознакомиться с данным разделом. 
...
Во избежание недоразумений, **мы также хотим особо подчеркнуть следующее**:
  ...
  1. Текст разделов "Преамбула" и "Применение" данного Документа носят
     разъяснительный характер. В случае возникновения правовых разночтений с
     разделом "Лицензионное соглашение", либо с национальными законами
  ...
  3. Законы об Авторском праве не распространяются на идеи, лежащие в основе
...
### Секция 2. Условия и Положения.
  ...
  - 2.3. Насколько это позволяет закон, _Авторское Произведение_ предоставляется
  ...
  - 2.4. В рамках настоящего соглашения _Автор_ **не предоставляет**
    _Лицензиату_ право сублицензирования, или передачи любой из предоставленных
    лицензий третьей стороне.

  - 2.5. Любая из предоставляемых по условиям настоящего
  ...
  - 2.6. Все лицензии, предоставляемые по условиям настоящего
  ...
  - 2.7. В случае принятия решения об отзыве лицензии _Автор_ берёт на себя
  ...
  - 2.8. В случае предъявления претензий в письменном виде со стороны
  ...
  - 2.9. Любая из предоставленных по условиям настоящего
...
Данный раздел описывает способы применения Libertarian Software License, и
...
сделать следующее:
  ...
  1. В этом случае Вам необходимо в файле `README.md`, желательно в шапке файла,
     ...
     [Libertarian Software License](https://link-to-the-license).
     ```
...
вклада большого числа соавторов. Во многих случаев проект действительно может
является индивидуально-авторским, несмотря на то, что он был изначально
опубликован по FOSS лицензией, либо содержит совсем небольшое число файлов,
написанных в соавторстве. В этом случае Вы можете перейти на
Libertarian Software License, просто применив список действий из предыдущего
раздела.
...
Надеемся, что Ваша следующая работа будет больше подходить для
Libertarian Software, и Вы сможете выбрать нашу Лицензию.
...
В этом случае Guitar, как юридическое лицо, автоматически получаете право
...
Допустим, какой-нибудь другой пользователь, назовём его Wally, пожелал сделать
...
В результате распространения и популяризации Вашей работы в среде
...
В свою очередь, хотя LSL формально не налагает на Вас обязательств по финансовым
