...
We grant permissions to everyone to translate this text to other languages, and
distribute translated copies together with verbatim copies of this text.
...
возможностей для использования своего произведения, включающую в том числе
возможность использования произведения с коммерческой целью. Для юридических лиц
Автор предоставляет ограниченную лицензию, дающую право дословного копирования
и распространения копий своей работы с некоммерческой целью, но не
предоставляющей право использования своей работы по прямому назначению, как
компьютерной программы.

Автор предоставляя свою работу другим лицам в форме бессрочной и бесплатной
аренды без права изменять содержание работы. Ни одна из предоставляемых лицензий
не даёт право получателю лицензии вносить изменения в работу Автора.
...
### Секция 1. Термины.
  ...
  - 1.20. **Скомпилированная Работа(Compiled Work)**.
    ...
    содержимого _Авторского Произведения_ <u>в исходном, неизмененном виде</u>.
  ...
  - 1.21. **Использование по Назначению(Intended Use)**.
    ...
    использования третьими лицами, пользователями компьютерных систем.
...
### Секция 2. Условия и Положения.
  ...
  - 2.5. В дополнение к пункту 2.4, _Лицензиат_, как физическое лицо,
    ...
    пределах положений полученной лицензии, в интересах третьих лиц, при
...
_Авторское Произведение_:
  ...
  - 4.1.1. **Право _Использования по Назначению_**.
  ...
  - 4.1.2. **Право создания _Комплементарной Работы_**.
  ...
  - 4.1.3 **Право дословного копирования и распространения дословных копий
    _Авторского Произведения_**.

    Право предоставляется при условии, что _Лицензиат_ прилагает
    _Уведомление об Авторском Праве_ к распространяемым копиям, актуальное
    на момент создания копий.

    При этом _Автор_ предоставляет право _Лицензиату_ распространять
    _Авторское Произведение_ на условиях _Лицензиата_(и, в том числе, с целью
    извлечения прямой или косвенной коммерческой выгоды), но со следующими
    ограничениями:

      * Насколько это позволяет закон, распространение _Авторского Произведения_
        не налагает на _Автора_ иной ответственности в отношении третьих лиц.

      * Условия распространения ограничены во времени моментом прекращения
        действия Лицензии согласно правилам, установленным
        _Лицензионным Соглашением_.

      * _Лицензиат_ <u>не предоставляет</u> права сублицензирования
        копий _Авторского Произведения_ третьим лицам.

      * _Лицензиат_ <u>не предоставляет</u> права тетьим лицам на создание
        _Производной Работы_, _Комплементарной Работы_ и
        _Скомпилированной Работы_, но не ограничивая прав третьих лиц на
        добросовестное использование в отношении _Авторского Произведения_.

  - 4.1.4 **Право создания и распространение _Скомпилированной Работы_**.

    Право предоставляется при условии, что _Лицензиат_ прилагает
    _Уведомление об Авторском Праве_ к распространяемым
    _Скомпилированным Работам_, актуальное на момент создания
    _Скомпилированной Работы_.

    При этом _Автор_ предоставляет право _Лицензиату_ распространять
    _Скомпилированные Работы_ на любых условиях _Лицензиата_(и, в том числе, с
    целью извлечения прямой или косвенной коммерческой выгоды), но со следующими
    ограничениями:

      * Насколько это позволяет закон, распространение _Скомпилированной Работы_
        не налагает на _Автора_ иной ответственности в отношении третьих лиц.
      ...
      * _Лицензиат_ <u>не предоставляет</u> права сублицензирования
        копий _Скомпилированной Работы_ третьим лицам.
    
  - 4.1.5. Право создания и распространения 

  - 4.1.5. Право распространения совместной совокупности _Комплементарной Работы_ в том числе(но не
    ограничивая) совместно

    При этом _Автор_ предоставляет _Лицензиату_ право создания Продукта на
    основе совместной совокупности _Комплементарной Работы_ _Лицензиата_ и
    _Авторского Произведения_(либо _Скомпилированной Работы_), в форме
    _Компьютерной Программы_, в том числе(но не ограничивая) с коммерческой
    целью.

    _Автор_ предоставляет право _Лицензиату_ распространять данный Продукт на
    любых условиях _Лицензиата_ до момента отзыва Лицензии по правилам,
    установленным _Лицензионным Соглашением_, и при строгом соблюдании
    _Лицензиатом_ всех перечисленных следующих условий:

      * Условия распространения Продукта, насколько это позволяет закон, не
        налагают на _Автора_ иной ответственности в отношении третьих лиц.
  ...
  - 4.1.4 В дополнение к пункту 4.1.3. Если для предусмотренного _Лицензиатом_
    функционирования Продукта, построенного на _Комплементарной Работе_
    _Лицензиата_, необходимо так же включение _Исходных Кодов_
    _Авторского Произведения_ с целью их _Интерпретации_, то _Исходные Коды_
    _Авторского Произведения_ могут быть включены в Продукт _Лицензиата_, при
    условии, при соблюдении _Лицензиатом_ всех перечисленных следующих условий:
