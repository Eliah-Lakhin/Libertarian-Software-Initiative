...
предоставляя свою работу другим лицам в форме бессрочной и бесплатной аренды без
права изменять содержание работы. Так же Автор оставляет за собой право отзыва
лицензий, в качестве крайней дополнительной меры, гарантирующей его права, как
эксклюзивного правообладателя.
...
Ни одна из предоставляемых лицензий не даёт право получателю лицензии вносить
...
### Секция 1. Термины.
  ...
  - 1.21. **Использование по Назначению(Intended Use)**.
    ...
    _Авторского Произведения_, либо _Скомпилированной Работы_) для использования
    третьими лицами, пользователями компьютерных систем.

  - 1.22 <span id="complementary_work">**Комплементарная Работа(Complementary Work)**</span>.
    ...
    _Авторского Произведения_ не включены в _Исходные Коды_ Комплементарной
    Работы, и предполагая, что полученная Комплементарная Работы _Лицензиата_,
    как _Компьютерная Программа_, будет функционировать в результате
    _Компиляции_ или _Интерпретации_ совместной совокупности _Исходных Кодов_
    Комплементарной Работы _Лицензиата_,
    _Исходных Кодов_ _Авторского Произведения_, _Скомпилированной Работы_, и
    возможно, иных компонентов компьютерных систем.
...
_Авторское Произведение_:
  ...
  - 4.1.1 **Право дословного копирования и распространения дословных копий
    ...
    актуальное на момент создания копий.
  ...
  - 4.1.3. **Право _Использования по Назначению_.**
  ...
  - 4.1.4. **Право создания <a href="#complementary_work">_Комплементарной Работы_</a>.**
