...
### Секция 2. Условия и Положения.
  ...
  - 2.3. Если _Лицензиат_ является юридическим лицом, либо лицом, представляющим
    в отношении _Автора_ интересы юридического лица или организации, как
    выгодополучателя в отношении использования _Авторского Произведения_, то
    _Автор_ предоставляет _Лицензиату_ "Лицензию для юридических лиц"(Секция 3).

  - 2.4. Если _Лицензиат_ является физическим лицом, действует в отношении
    _Автора_ от своего лица, и не представляет интересов третьей стороны, в том
    числе(но не ограничивая) интересы иных физических и юридических лиц,
    коммерческих организаций, фирм, корпораций, некоммерческих, религиозных и
    благотворительных организаций, научно-исследовательских институтов,
    образовательных учреждений и государственных учреждений, и не являясь
    представителем любого коллектива, как выгодополучателя в отношении
    использования _Авторского Произведения_, _Автор_ предоставляет _Лицензиату_
    "Лицензию для физических лиц"(Секция 4).

  - 2.5. В дополнение к пункту "2.4.", _Лицензиат_, как физическое лицо,
    удовлетворяющее перечисленным в пункте "2.4." условиям, с момента вступления
    _Контракта_ в силу, может использовать _Авторское Произведение_, в
    пределах положений полученной лицензии, при условии, что правовые
    взаимоотношения в пределах _Контракта_ между _Лицензиатом_ и _Автором_ будут
    продолжать регулироваться, как между физическими лицами на изначальных
    условиях _Контракта_. В противном случае действие всех лицензий,
    предоставленных _Автором_ _Лицензиату_ по условию
  ...
  - 2.8. Любая из предоставляемых по условиям настоящего
  ...
  - 2.9. Все лицензии, предоставляемые по условиям настоящего
  ...
  - 2.10. В случае принятия решения об отзыве лицензии _Автор_ берёт на себя
  ...
  - 2.11. В случае предъявления претензий в письменном виде со стороны
  ...
  - 2.12. Любая из предоставленных по условиям настоящего
